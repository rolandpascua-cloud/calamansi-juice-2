...
// Calamansi Juice 2 addition: used by the Telemetry History Viewer tab
// (ModelManager.tsx's left-panel rail, HistoryPanel.tsx).
export const History: React.FC<IconProps> = ({ size = 24, strokeWidth = 2 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
